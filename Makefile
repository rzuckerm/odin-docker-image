ODIN_VERSION := $(shell cat ODIN_VERSION)
ODIN_DEPS := $(wildcard ODIN_*)
DOCKER_TAG_PREFIX := rzuckerm/odin:$(ODIN_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(ODIN_DEPS)
...
$(META_BUILDX_TARGET): $(META_CREATE_BUILDER_TARGET) Dockerfile Makefile $(ODIN_DEPS)
